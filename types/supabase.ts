  ...
  public: {
    Tables: {
      ...
      details_commande_db: {
        ...
        Relationships: [
          {
            foreignKeyName: "d├⌐tails_commande_db_commande_r_fkey"
            columns: ["commande_r"]
            isOneToOne: false
            referencedRelation: "commande_db"
            referencedColumns: ["idcommande"]
          ...
          {
            foreignKeyName: "d├⌐tails_commande_db_plat_r_fkey"
            columns: ["plat_r"]
            isOneToOne: false
      ...
      evenements_plats_r: {
        ...
        Relationships: [
          {
            foreignKeyName: "├ëv├⌐nements_plats_r_evenement_id_fkey"
            columns: ["evenement_id"]
            isOneToOne: false
            referencedRelation: "evenements_db"
            referencedColumns: ["idevenements"]
          ...
          {
            foreignKeyName: "├ëv├⌐nements_plats_r_plat_id_fkey"
            columns: ["plat_id"]
            isOneToOne: false
            referencedRelation: "mv_plats_populaires"
            referencedColumns: ["idplats"]
    ...
    Enums: {
      ...
      source_connaissance:
        ...
        | "Autre"
      statut_acompte: "Non applicable" | "Demand├⌐" | "Re├ºu"
      statut_commande:
      ...
      statut_evenement:
        ...
        | "Devis ├á faire"
        | "Devis envoy├⌐"
        | "Confirm├⌐ / Acompte en attente"
        | "Confirm├⌐ / Acompte re├ºu"
        | "En pr├⌐paration"
        | "R├⌐alis├⌐"
        | "Factur├⌐ / Solde ├á payer"
        | "Pay├⌐ int├⌐gralement"
        | "Annul├⌐"
      statut_paiement:
        ...
        | "Non pay├⌐"
        | "Pay├⌐e"
      statut_paiement_final: "En attente" | "Pay├⌐" | "En retard"
      type_evenement:
        | "Anniversaire"
        | "Repas d'entreprise"
        | "F├¬te de famille"
        ...
        | "Buffet traiteur"
        | "Autre"
      type_livraison: "├Ç emporter" | "Livraison" | "Sur place"
      unite_ingredient:
        | "g"
        | "L"
        | "ml"
