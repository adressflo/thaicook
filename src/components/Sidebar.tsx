  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        >
          <Link to="/" className="flex items-center space-x-2 overflow-hidden w-full" onClick={handleLinkClick}>
            <img 
              src={logoPath} 
          ...
          {navigation.map((item) => item && (
            ...
            >
              <item.icon className={cn(
                ...
                isActive(item.href) ? "text-white" : "text-thai-orange group-hover:text-thai-orange"
              )} />
