                  ...
                  {imgSrcForCrop && (
                    <Card className="mt-4 w-full p-4">
                      ...
                      <div className="flex justify-center gap-4 mt-4">
                        <Button onClick={handleApplyCrop} className="bg-thai-green hover:bg-thai-green-dark"><CheckSquare className="mr-2 h-4 w-4"/>Appliquer</Button>
                        <Button onClick={handleCancelCrop} variant="outline" className="border-thai-orange text-thai-orange hover:bg-thai-orange/10"><XSquare className="mr-2 h-4 w-4"/>Annuler</Button>
                      </div>
                    </Card>
                  )}
