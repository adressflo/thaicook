          ...
          <CardContent className="space-y-6">
            ...
            <Alert className="bg-amber-50 border-amber-200">
              ...
              <AlertDescription className="text-sm text-amber-800 ml-2">
                <strong>Sécurité :</strong> Votre mot de passe actuel est requis pour modifier votre email.
                Après la modification, vous devrez vérifier votre nouvel email.
              </AlertDescription>
            </Alert>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Alert className="bg-blue-50 border-blue-200">
                ...
                <AlertDescription className="text-sm text-blue-800 ml-2">
                  <strong>Important :</strong> Un email de vérification sera envoyé à votre nouvelle adresse.
