...
export default function HistoryCompletClient() {
  ...
  const handlePageChange = (newPage: number) => {
    ...
    router.push(`/historique/complet?${params.toString()}` as Route)
  }
  ...
  // result object structure: { data: { data: ..., totalPages: ... }, serverError?: ..., validationErrors?: ... }
  // We need to access result.data?.data for the actual list
