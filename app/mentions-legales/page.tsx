      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Informations légales conformément à l'article 6 de la loi n°
        ...
        <div className="space-y-8">
          ...
          <section className="rounded-lg bg-white p-6 shadow-sm border border-gray-200">
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p>
                <strong>Exploitant :</strong> MME CHAMPA Chanthana (Nom d'usage
                : FOUQUET)
              </p>
              <p>
              ...
              <p>
                <strong>Code APE :</strong> 5610C - Fabrication de plats
                cuisinés à emporter
              </p>
              <p>
              ...
              <p>
                <strong>Immatriculation :</strong> Répertoire des Métiers le
                28/12/2021
              </p>
              <p>
          ...
          <section className="rounded-lg bg-white p-6 shadow-sm border border-gray-200">
            ...
            <div className="space-y-2 text-gray-700">
              <p>
                <strong>Directrice de la publication :</strong> MME CHAMPA
                Chanthana
              </p>
              <p>
          ...
          <section className="rounded-lg bg-white p-6 shadow-sm border border-gray-200">
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p>
                <strong>Photographies :</strong> © Chanthana Thai Cook - Tous
                droits réservés
              </p>
            </div>
          </section>
