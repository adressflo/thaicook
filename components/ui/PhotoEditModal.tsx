  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-thai-orange flex items-center gap-2">
        ...
        <div className="space-y-4">
            ...
            <TabsContent value="upload" className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex w-full items-center justify-center">
                  <label
                    htmlFor="file-upload"
                    className="border-thai-gold/30 from-thai-cream/10 to-thai-gold/5 hover:border-thai-gold/50 hover:bg-thai-gold/10 flex h-32 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed bg-linear-to-br transition-all duration-200"
                  >
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      <Upload className="text-thai-gold mb-2 h-8 w-8" />
          ...
          {imageUrl && (
            <div className="space-y-2">
              <Label>Aperçu</Label>
              <div className="from-thai-cream/10 to-thai-gold/5 border-thai-gold/20 flex justify-center rounded-lg border bg-linear-to-br p-4">
                <img
                  src={imageUrl}
                  alt="Aperçu"
        ...
        <DialogFooter className="flex justify-end">
          <Button
            ...
            className="from-thai-orange to-thai-red hover:from-thai-red hover:to-thai-orange flex items-center gap-2 bg-linear-to-r text-white transition-all duration-300"
          >
            {isLoading ? (
